...
$secdet090=$obj->update_consecurity($secid,$cat,$name,$lname,$mbno,$code,$shift,$dno,$address,$newFilePath,$newFilePath2);
//$secdet090=$obj->mysecu_hire($secid,$cat,$name);
if($secdet090==1)
{
//echo "<script> alert('Security Created Successfully');</script>";
header("location:SecurityManagement_ContractHire.php?cadd=success");
}
...
<div id="main" class="container-fluid">
	<div class="row">
		...
		<a href="#" class="add_page_button">Edit contract Staff <span class="fa fa-plus"></span> </a>
		...
		if($_SESSION['ceid']!="")
		{
			$csecurity_id=$_SESSION['ceid'];
		}
	
		$secc=$obj->getsecurity_update($csecurity_id);
...
<img src="uploads/security_gallery/<?php echo  $sec['security_image']; ?>" 
...
style="  margin-left: 5%;  margin-top: 26%;" id="box" />
				...
				enctype="multipart/form-data">
					<input type="hidden" name="secid" value="<?php echo $sec['security_id']; ?>"  />    			
                    ...
                    <div class="clearfix"></div>
             <div style="color:red" class="col-sm-3"><input type="text" class="form-control" placeholder="Name" name="name" value="<?php echo $sec['security_name']; ?>" /></div>
                    <div style="color:red" class="col-sm-3"><input type="text" class="form-control" placeholder="Last name" name="lname" value="<?php echo $sec['security_lname']; ?>" /></div>
                    <div  class="col-sm-3">
<input type="text" class="form-control" placeholder="Mobile" name="mbno" value="<?php echo $sec['security_mobile']; ?>"  />
...
<div class="clearfix">
                    ...
                    <div style="color:red" class="col-sm-3"><input type="text" class="form-control" placeholder="Code" name="code" value="<?php echo $sec['security_code']; ?>" /></div>
...
<option value="<?php echo $row['agency_companyname'];?>"
 <?php if($row['agency_companyname']==$sec['security_cat']){ echo 'selected="selected"'; } ?> >
 <?php echo $row['agency_companyname'];?></option>
				...
				<option value="Day Shift"<?php if ($sec['security_shift_type'] === 'Day Shift') echo ' selected="selected"'; ?>>Day Shift</option>
 <option value="Night Shift"<?php if ($sec['security_shift_type'] === 'Night Shift') echo ' selected="selected"'; ?>>Night Shift</option>
					<option value="Total Shift"<?php if ($sec['security_shift_type'] === 'Total Shift') echo ' selected="selected"'; ?>>Total</option>
					</select>
 ...
 <div class="clearfix"></div>                   
				   ...
				   name="dno" value="<?php echo $sec['security_Dno']; ?>" /></div>
                 <div class="col-sm-3">
  ...
  background-color: #fff;  background-position: right center;  background-size: 20px;"  value="<?php echo $sec['security_address']; ?>"/>
					...
					<div><img src="
					uploads/Security_multiple_images/<?php echo  $sec['security_upload_id']; ?>"  height="80"
