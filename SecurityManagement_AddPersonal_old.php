...
if($cat=="Select Category" || $name=="" || $lname=="" || $mbno1==""|| $code==""|| $cname==""|| $shift=="" || $address==""  )
{
...
$data=$obj->create_security($cat,$name,$lname,$mbno,$code,$cname,$shift,$address,$newFilePath,$password,$email,$newFilePath2);
...
<div id="main" class="container-fluid">
	<div class="row">
		...
		<a href="#" class="add_page_button">personal <span class="fa fa-plus"></span> </a>
				...
				<form id="defaultForm" method="post" action="" class="form-horizontal" enctype="multipart/form-data">
					...
					<span style="color:red">
					 ...
					 ?>
						...
						?>
<option value="<?php echo $row['security_hire_id'];?>"><?php echo $row['security_hire_companyname'];?></option>
