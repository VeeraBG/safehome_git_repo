...
<form action="excel.php" method="post" enctype="multipart/form-data">
	  <div class="col-sm-3" ><a href="#" class="add_page_button">Upload Excel File:</a></div>
  <div class="col-sm-3" >
...
else
{
	$image="img/profile-icon.png";
	   ...
	   <td>
<a href="javascript:" class="owner<?php $get_rec['owner_id']; ?>"
onClick="editButton('<?php echo $get_rec['owner_id']; ?>')">
