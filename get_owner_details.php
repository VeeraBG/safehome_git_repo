...
{
$final=date(', F Y', strtotime("-$j month",strtotime(date("Y-m")))); 
...
echo "<input type='hidden' name='mymonth[]' value='$month_name'>";

for($i=0;$i<count($my_stored_variable); $i++)
{
$store_val = $my_stored_variable[$i];
?>
	<?php
				echo "<div class='col-sm-2'>				
				  ...
				  <input type='text' class='form-control'  name='amount[$j][$store_val]' value=''>
