...
<div id="main" class="container-fluid">
	<div class="row">
		...
		<a href="#" class="add_page_button">Add Pre schedule Visitor <span class="fa fa-plus"></span> </a>
...
style="  margin-left: 5%;  margin-top: 26%;" id="box" />
  ...
  background-color: #fff;  background-position: right center;  background-size: 20px;"/>
			...
			<div class="col-sm-3"><input type="hidden" class="form-control" placeholder="Enter Dno" name="dno" /></div>
                    <div class="col-sm-3"></div>
                    <div class="clearfix"></div>
                          <br>         
