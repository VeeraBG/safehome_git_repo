...
$sft=$obj1->search_visitor_fromto($fromdate,$todate);
...
<!--Popup End--><!--View Visitor Info Popup End-->
			...
			while($sql_getz=mysql_fetch_array($sft))
				{
			
					//print_r($sql_getz);
				$date=$sql_getz['visitor_date'];
				$time=date('h:i a', strtotime($date)); 

				
			    ?>
                <div class="person_list" onClick="personinfo('<?php echo $sql_getz['visitor_id']; ?>');">
           	    <img src="visitor_gallery/<?php echo $sql_getz['visitor_image']; ?>" width="100" height="100"
				class="img-rounded">
                <div class="clearfix"></div>
                    <div class="name"><?php echo $sql_getz['visitor_fname']; ?>. <?php echo $sql_getz['visitor_lname']; ?></div>
                    <div class="mobile"><?php echo $sql_getz['visitor_mobile']; ?></div>
